...
|                  | 5V (来自 UNO) | CD4052BE #1     | 16 (VDD)        | +5V Logic Power         | **并联**到芯片 #2 的 Pin 16                             |
|                  | 5V (来自 UNO) | CD4052BE #2     | 16 (VDD)        | +5V Logic Power         | **并联**到芯片 #1 的 Pin 16                             |
|                  | GND           | CD4052BE #1     | 8 (VSS)         | Ground                  | **共地**                                                |
|                  | GND           | CD4052BE #1     | 7 (VEE)         | Ground                  | **共地**                                                |
|                  | GND           | CD4052BE #2     | 8 (VSS)         | Ground                  | **共地**                                                |
|                  | GND           | CD4052BE #2     | 7 (VEE)         | Ground                  | **共地**                                                |
| **CD4052BE**     |               |                 |                 |                         | **(1-16 号引脚顺序重排)**                               |
|                  |               | **CD4052BE**    | 1 (Y0B)         | 通道 B 输出 0           | 见下方通道分配                                          |
|                  |               | **CD4052BE**    | 2 (Y2B)         | 通道 B 输出 2           |                                                         |
|                  |               | **CD4052BE**    | 3 (ZB)          | 公共输入 B              | Arduino D7/D9                                           |
|                  |               | **CD4052BE**    | 4 (Y3B)         | 通道 B 输出 3           |                                                         |
|                  |               | **CD4052BE**    | 5 (Y1B)         | 通道 B 输出 1           |                                                         |
|                  |               | **CD4052BE**    | 6 (E_bar)       | 使能（低有效）          | Arduino D12                                             |
|                  |               | **CD4052BE**    | 7 (VEE)         | 电源/地                 | GND                                                     |
|                  |               | **CD4052BE**    | 8 (VSS)         | 电源/地                 | GND                                                     |
|                  |               | **CD4052BE**    | 9 (A1)          | 选择位 1                | Arduino D11                                             |
|                  |               | **CD4052BE**    | 10 (A0)         | 选择位 0                | Arduino D10                                             |
|                  |               | **CD4052BE**    | 11 (Y3A)        | 通道 A 输出 3           |                                                         |
|                  |               | **CD4052BE**    | 12 (Y0A)        | 通道 A 输出 0           |                                                         |
|                  |               | **CD4052BE**    | 13 (ZA)         | 公共输入 A              | Arduino D6/D8                                           |
|                  |               | **CD4052BE**    | 14 (Y1A)        | 通道 A 输出 1           |                                                         |
|                  |               | **CD4052BE**    | 15 (Y2A)        | 通道 A 输出 2           |                                                         |
|                  |               | **CD4052BE**    | 16 (VDD)        | +5V                     | 5V                                                      |
| **ULN2003 #1**   |               |                 |                 |                         | **(驱动 Motor 1, 使用标准 ULN2003 模块，连接 IN1-IN4)** |
...
| **ULN2003 #2**   |               |                 |                 |                         | **(驱动 Motor 2, 使用标准 ULN2003 模块，连接 IN1-IN4)** |
...
|                  | + (5-12V)     | 独立 5V 电源    | +5V             | Power Input             |                                                         |
|                  | - (GND)       | 独立 5V 电源    | GND             | Ground                  | **共地**                                                |
| **ULN2003 #3**   |               |                 |                 |                         | **(驱动 Motor 3, 使用标准 ULN2003 模块，连接 IN1-IN4)** |
...
|                  | + (5-12V)     | 独立 5V 电源    | +5V             | Power Input             |                                                         |
|                  | - (GND)       | 独立 5V 电源    | GND             | Ground                  | **共地**                                                |
| **ULN2003 #4**   |               |                 |                 |                         | **(驱动 Motor 4, 使用标准 ULN2003 模块，连接 IN1-IN4)** |
...
|                  | + (5-12V)     | 独立 5V 电源    | +5V             | Power Input             |                                                         |
|                  | - (GND)       | 独立 5V 电源    | GND             | Ground                  | **共地**                                                |
| **ULN2003 #5**   |               |                 |                 |                         | **(驱动 Motor 5, 使用标准 ULN2003 模块，连接 IN1-IN4)** |
